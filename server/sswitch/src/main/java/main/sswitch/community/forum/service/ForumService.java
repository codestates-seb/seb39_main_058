package main.sswitch.community.forum.service;

import main.sswitch.community.forum.entity.Forum;
import main.sswitch.community.forum.repository.ForumRepository;
...
public class ForumService {
    ...
    public Forum updateForum(Forum forum) {
        ...
        Optional.ofNullable(forum.getGenre())
                .ifPresent(genre -> findForum.setGenre(genre));
